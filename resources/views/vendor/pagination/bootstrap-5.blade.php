<?php if ($paginator->hasPages()): ?>
    <nav>
        <ul class="pagination pagination-sm mb-0"> <!-- pagination-sm para botones pequeños -->
            ...
            <?php else: ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo $paginator->previousPageUrl(); ?>" rel="prev" aria-label="Anterior">&lsaquo;</a>
                </li>
            <?php endif; ?>

            <!-- Elementos de página (números) -->
            ...
            <?php if ($paginator->hasMorePages()): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo $paginator->nextPageUrl(); ?>" rel="next" aria-label="Siguiente">&rsaquo;</a>
                </li>
            <?php else: ?>
